...
- **Switch framing** with the *Disease areas ⇄ Hypotheses* toggle. The hypothesis view recolours the same literature by the 8 mechanistic "Alzheimer's cure" bets (amyloid, tau, lipid/APOE, microglia, endocytosis, synaptic, vascular, epigenetic) and ranks them by *translation gap* — strong genetics/biology with little clinical translation — in a panel under the map.
